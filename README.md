...
- `적·의·것·들`, 군더더기 `있다/수 있다`, 피동, 무생물 주어, 직역 대명사·전치사, 명사화, 만연체를 다루는 28개 문장 규칙
- `예요/이에요`부터 사이시옷·두음법칙·외래어 표기까지 세분한 24개 교정 규칙
- 사물존칭·간접높임·객체높임·종결체·쉬운 공공언어를 구분하는 9개 문체 규칙
- 제목·주제명·SEO 키워드 같은 편집 표지를 통용 명칭이나 본문 사실로 승격하지 않는 근거 경계 규칙
...
### 9. 편집용 주제명을 본문 사실로 만들지 않기

**입력 자료**

> 주제 메모: 한밤중 친구 장면
>
> 본문: 누가복음 11장 5절부터 13절에는 한 사람이 밤중에 벗을 찾아가 떡을 구하는 장면이 나옵니다.

**잘못된 윤문**

> 이 본문은 보통 ‘한밤중 친구 비유’로 소개됩니다.

**안전한 윤문**

> 누가복음 11장 5절부터 13절에는 한 사람이 밤중에 벗을 찾아가 떡을 구하는 장면이 나옵니다.

주제 메모는 글의 방향을 정하는 편집 표지일 뿐, 그 이름이 널리 쓰인다는 증거가 아닙니다. 자연스러운 도입을 만들기 위해 출처 없는 명명 관행·역사·대중적 합의를 덧붙이지 않습니다.
